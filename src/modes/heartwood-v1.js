// Heartwood "Simple" mode (v1) — public name "Heartwood — Simple". A FROZEN
// snapshot of the original Heartwood composition, kept as its own wallpaper.
// The flagship "Heartwood" (src/modes/heartwood.js) continues from here, adding
// undulating roots and a canopy growing off the top of the frame.
// A surreal Art Nouveau forest.
//
...
(function (App) {
  App.createHeartwoodV1 = function (deps) {
